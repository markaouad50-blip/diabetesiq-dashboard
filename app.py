...
/* 2. HEADER / FOOTER — match bg, give room so first title isn't clipped */
...
[data-testid="stSidebar"] p     { color:#cce8f0 !important; }
...
[data-testid="stTabs"] button[aria-selected="true"] { color:#00d4aa !important; border-bottom:2px solid #00d4aa !important; }

/* 6. GENERAL TEXT — h* tags only (safe: .sec-hdr is a div, not an h-element) */
.stApp h1,.stApp h2,.stApp h3,
.stApp h4,.stApp h5,.stApp h6   { color:#cce8f0 !important; }
[data-testid="stMarkdownContainer"] p,
[data-testid="stMarkdownContainer"] li  { color:#cce8f0; }
[data-testid="stMarkdownContainer"] strong { color:#ffffff; }
p, label                         { color:#cce8f0 !important; }

/* 7. SECTION HEADERS — target the div AND every child so emoji spans can't override */
div.sec-hdr,
div.sec-hdr *                    { color:#00d4aa !important; }
div.sec-hdr {
