...
st.markdown("""
<style>
/* ── Remove white top gap & toolbar background ── */
header[data-testid="stHeader"] { background-color: #0a1628 !important; }
.stApp > header { background-color: #0a1628 !important; }
#MainMenu { visibility: hidden; }
.block-container { padding-top: 1.5rem !important; }
footer { visibility: hidden; }

/* ── Force dark background everywhere (works even if config.toml isn't picked up) ── */
.stApp,
...
/* Headers, paragraphs, labels inside main */
.stApp h1, .stApp h2, .stApp h3,
.stApp p, .stApp span, .stApp label,
.stApp li, .stApp div { color: #cce8f0; }
/* Tabs */
[data-testid="stTabs"] button { color: #8ab4c9 !important; }
...
/* Dataframe */
[data-testid="stDataFrame"] { background: #1a2744 !important; }
/* Selectbox / multiselect / radio */
[data-testid="stSelectbox"] > div,
[data-testid="stMultiSelect"] > div { background: #1a2744 !important; color: #cce8f0 !important; }
/* Number inputs */
[data-testid="stNumberInput"] input { background: #1a2744 !important; color: #cce8f0 !important; }
/* Metric cards */
...
/* Section header */
.sec-hdr {
    color:#00d4aa;font-size:1.5rem;font-weight:700;
...
.type-card h3{color:#00d4aa;margin-bottom:8px;}
...
def load_pima():
    """Returns cleaned DataFrame or None if the file is missing."""
    try:
...
def get_trained_models():
    """Self-contained: loads Pima, trains LR + RF, returns all artefacts or None."""
    try:
        df = pd.read_csv(PIMA_PATH)
        for c in ["Glucose","BloodPressure","SkinThickness","Insulin","BMI"]:
            if c in df.columns:
